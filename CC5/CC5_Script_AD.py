...
directory = r"C:\Data\Students_2022\Dark\CC5"
outputDirectory = "Years_Directory2"
    ...
    with open(os.path.join(directory, r"CC5_CSV.csv")) as the_csv:
        ...
        for row in csv_reader:
            if row[2] == year:
                file.write(",".join(row))
                file.write("\n")
        file.close() #AD - Added this to see if it makes a difference, should not because of the with.
